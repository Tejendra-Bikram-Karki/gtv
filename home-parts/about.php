<<<<<<< HEAD
<section class="about_area section-padding mh-100-vh dots-bg d-md-flex align-items-md-center bg-dark py-5">
    <div class="container py-5">
        <div class="row align-items-center pt-5">
            <div class="col-lg-5">
                <div class="about_thumb d-none d-md-block align-start">
                    <img src="<?php bloginfo('template_directory'); ?>/assests\img\logo.svg" class="about-img center" alt=""
