<?
// Template Name: Social Icons
?>

<div class="col-md-3 mb-3 text-center ">
    <h5>Social Profiles</h5>
    <ul class="nav flex-column d-flex align-items-center">
        <li class="nav-item mb-2"><a href="#" class="p-0 text-white"><span class="me-2 fa-brands fa-facebook"
        ...
        <li class="nav-item mb-2"><a href="#" class="p-0 text-white"><span class="me-2 fa-brands fa-linkedin"
